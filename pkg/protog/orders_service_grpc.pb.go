...
type OrdersServiceClient interface {
	Find(ctx context.Context, in *FindOrderRequest, opts ...grpc.CallOption) (*FindOrderResponse, error)
...
func (c *ordersServiceClient) Find(ctx context.Context, in *FindOrderRequest, opts ...grpc.CallOption) (*FindOrderResponse, error) {
	out := new(FindOrderResponse)
	err := c.cc.Invoke(ctx, "/dd.OrdersService/Find", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrdersServiceServer) Find(context.Context, *FindOrderRequest) (*FindOrderResponse, error) {
...
func _OrdersService_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dd.OrdersService/Find",
	}
